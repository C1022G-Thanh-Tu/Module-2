    ...
    public static void main(String[] args) {
        ...
        for (Shape shape : shapeArray) {
            if (shape instanceof Circle) {
                ...
                System.out.print("Diện tích hình tròn trước khi thay đổi: ");
                circle.resize(0);
                System.out.print("Diện tích hình tròn sau khi thay đổi: ");
                circle.resize((Math.floor(Math.random() * 100) + 1) / 100);
                System.out.println();
            } else if (shape instanceof Rectangle) {
                Rectangle rectangle = (Rectangle) shapeArray[1];
                System.out.print("Diện tích hình chữ nhật trước khi thay đổi: ");
                rectangle.resize(0);
                System.out.print("Diện tích hình chữ nhật sau khi thay đổi: ");
                rectangle.resize((Math.floor(Math.random() * 100) + 1) / 100);
                System.out.println();
            } else {
                Square square = (Square) shapeArray[2];
                System.out.print("Diện tích hình vuông trước khi thay đổi: ");
                square.resize(0);
                System.out.print("Diện tích hình vuông sau khi thay đổi: ");
